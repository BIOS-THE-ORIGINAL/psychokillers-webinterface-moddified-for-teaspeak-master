...
$server[0]['ip']= "127.0.0.1";
$server[0]['tport']= 10101;

$cfglang	=	"de";			//Language German = de, English = en, Netherlandish=nl (by pd1evl), French = fr (by supra63200), Portuguese = br (by Rennato)
                                //Language Turkish = tr (by RoTrKO)
